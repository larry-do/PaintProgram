...
public interface Tool {
    ...
    public enum ToolType {
        AIRBRUSH, BRUSH, CALLIGRAPHY_PEN, PENCIL, CURVE_LINE, ELLIPSE, ISOSCELES_TRIANGLE, LINE, RECTANGLE, ROUNDED_RECTANGLE, SQUARE_TRIANGLE, ERASER, FLOOD_FILLER, TEXT, COLOR_PICKER, NULL
    };
